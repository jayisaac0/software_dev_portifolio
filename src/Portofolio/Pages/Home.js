        ...
        <div>
            <div className="HomeGrids">
                <div className="InnerGrid CenterContent">
                    ...
                    <img src={backgroundone} alt="landingimage" className="Landingimage animated zoomIn slower" />
                </div>
                {/* <img src={mockup} alt="landingimage" className="mdl-layout--large-screen-only" /> */}
                <div className="InnerGrid">
                <img src={backgroundfour} alt="landingimage" className="Landingimage animated zoomIn slower mdl-layout--large-screen-only" />
                    <br /><br />
                    <div className="SpacerSection" ></div>
                    <h2 className=" animated fadeInDown slower">About me</h2>
                    <br /><br />
                    <p className=" animated zoomIn slower">
                    I am a tech entusiast and like building awesome software. I've built websites, corporate software and management systems and even games! If you are interested, you can view some of my projects bellow.
                    </p>
                    <br /><br />
                    <div className="SpacerSection" ></div>
                    <div className="socialicons">
                        ...
                        <a className="FloatingNavMargin rightmargin" target="_newTab" href="https://github.com/jayisaac0">
                        <span className="mdl-chip mdl-chip--contact">
                        <span className="mdl-chip__contact mdl-color-text--white"><img src={github} alt={github} /></span>
                        ...
                        <span className="mdl-chip mdl-chip--contact">
                            <span className="mdl-chip__contact mdl-color-text--white"><img src={linkedin} alt={linkedin} /></span>
                            <span className="mdl-chip__text"> My Linkedin profile</span>
                        </span>
                        </a>
                        <a className="FloatingNavMargin rightmargin" target="_newTab" href="https://www.quora.com/profile/Joshua-Omwoyo-1">
                        <span className="mdl-chip mdl-chip--contact">
                            <span className="mdl-chip__contact mdl-color-text--white"><img src={quora} alt={quora} /></span>
